...
const PrivacyPolicy = () => {
  return (
    <ScrollView>
      ...
      <Text style={styles.bodyTextWrapper}>
        Centangle Interactives built the QR Scanner app as a Free app. This SERVICE is provided by Centangle Interactives at no cost and is intended for use as is.
      ...
      <Text style={styles.bodyTextWrapper}>
        For a better experience, while using our Service, we may require you to provide us with certain personally identifiable information. The information that we request will be
      ...
      <Text style={styles.bodyTextWrapper}>
        If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us at mushahidh224@gmail.com.
      </Text>
    </ScrollView >
  )
}
